...
def run():
    cfg = SchedulingExperimentConfig(
        ...
        arrival_rates=[44.0, 52.0],
        max_batch_sizes=[8],
        batch_timeouts_ms=[0.0],
        prefill_chunk_sizes=[256],
        max_tokens_per_iteration=1536,
        num_requests=120,
    ...
    for arrival_rate in cfg.arrival_rates:
        ...
        rows.append(_run_continuous(model, cfg, arrival_rate, prefill_chunk_size=256, max_tokens_per_iteration=1536))
